...
| [improve-codebase-architecture](skills/improve-codebase-architecture/SKILL.md) | Find deepening opportunities in a codebase, present them as an HTML report, then grill through a chosen one. Uses the next three skills. | Explicit only. | [Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/improve-codebase-architecture) |
| [codebase-design](skills/codebase-design/SKILL.md) | Shared deep-module vocabulary (module, interface, seam, adapter, depth) and the design-it-twice pattern. | Automatic selection allowed, or explicit invocation. | [Upstream source](https://github.com/mattpocock/skills/tree/main/skills/engineering/codebase-design) |
