---
name: unslop
description: Remove AI writing patterns only when the user explicitly invokes $unslop, /unslop, or asks to "use unslop". Never select this skill automatically.
---

# Unslop

## HARD GUARD: explicit invocation only
