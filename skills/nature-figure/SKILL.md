...
<!-- Captain's Kit: changed shared-reference paths for standalone installation. -->
...
`references/nature-shared/journal-formats/nature-machine-intelligence.md`. Apply its
